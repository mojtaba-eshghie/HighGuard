...
let sourceSource = fs.readFileSync(path.join(contractsDir, 'CrossSource.sol'), 'utf8');
let tokenSource = fs.readFileSync(path.join(contractsDir, 'CrossToken.sol'), 'utf8');
let destinationSource = fs.readFileSync(path.join(contractsDir, 'CrossDestination.sol'), 'utf8');
