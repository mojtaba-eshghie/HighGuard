...
contract ProductOrder {
    ...
    uint256 public orderCreationTime; // Time when the order was created
    ...
    function shipOrder() public {
        require(
            block.timestamp > orderCreationTime + 5 minutes ||
                status == OrderStatus.Confirmed,
            "Order must be confirmed or 5 minutes must have passed since creation."
        );
