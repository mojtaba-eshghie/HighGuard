...
contract Governance {
    ...
    function createProposal(uint256 voteThreshold) public returns (uint256) {
        ...
        // Allow setting an arbitrary vote threshold
        p.customVoteThreshold = voteThreshold > 0
            ? voteThreshold
    ...
    function executeProposal(uint256 proposalId) public {
        ...
        require(p.voteCount >= p.customVoteThreshold, "Votes below threshold");
