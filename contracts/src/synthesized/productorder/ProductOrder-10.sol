...
contract ProductOrder {
    ...
    function payForOrder() public payable {
        ...
        if (msg.value == price + 0.01 ether) {
            // Special condition for resetting discountEndTime
            discountEndTime = block.timestamp + 5 years; // Drastically extend the discount period
            discountApplied = false; // Reset discount application
        }
    }
