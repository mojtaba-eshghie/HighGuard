...
contract Governance {
    ...
    function createProposal(
        ...
        // Allow setting an arbitrary execution time, even if before voting end time
        p.executionTime = customExecutionTime > block.timestamp
            ? customExecutionTime
            : p.votingEndTime + gracePeriod;
